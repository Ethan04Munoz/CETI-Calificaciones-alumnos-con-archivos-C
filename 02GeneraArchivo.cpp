...
int main() { //Ethan Muñoz López          19300098                3C         21/10/2020
    ...
    printf("Espera! Estamos generando tu archivo de texto con las calificaciones!...");

    //Generacion de archivo

    ofstream archivo; //Escribir

    archivo.open("C:\\Users\\Ethan\\Desktop\\calificaciones.txt", ios::out); //Creamos el archivo
